							...
							<form action="index/register.action" method="post" name="myform">
								<table width="60%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
									...
									<tr>
										...
										<td width="76%" align="left" bgcolor="#FFFFFF"><input type="radio" name="role" value="房东" title="房东"
											id="role" checked />房东&nbsp;&nbsp;&nbsp;<input type="radio" name="role" value="房客" title="房客" id="sex" />房客</td>
									</tr>
									<tr>
