...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu">
			<dt>
				<i class="Hui-iconfont">&#xe62d;</i>房源类型信息管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
					<li><a data-href="cate/createCate.action" data-title="新增房源类型" href="javascript:void(0)">新增房源类型信息</a></li>
					<li><a data-href="cate/getAllCate.action" data-title="房源类型列表" href="javascript:void(0)">房源类型信息列表</a></li>
					<li><a data-href="cate/queryCateByCond.action" data-title="房源类型查询" href="javascript:void(0)">房源类型信息查询</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu">
			<dt>
				<i class="Hui-iconfont">&#xe62d;</i>房源信息管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
					<li><a data-href="goods/getAllGoods.action" data-title="房源列表" href="javascript:void(0)">房源信息列表</a></li>
					<li><a data-href="goods/queryGoodsByCond.action" data-title="房源查询" href="javascript:void(0)">房源信息查询</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu">
			<dt>
				<i class="Hui-iconfont">&#xe62d;</i>预约预约单信息管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
					<li><a data-href="orders/getAllOrders.action" data-title="预约预约单列表" href="javascript:void(0)">预约预约单信息列表</a></li>
					<li><a data-href="orders/queryOrdersByCond.action" data-title="预约预约单查询" href="javascript:void(0)">预约预约单信息查询</a></li>
					<li><a data-href="admin/chart.jsp" data-title="预约单统计" href="javascript:void(0)">预约预约单统计信息</a></li>
				</ul>
			</dd>
		</dl>
		...
		<dl id="menu">
			<dt>
				<i class="Hui-iconfont">&#xe62d;</i>举报反馈信息管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
			</dt>
			<dd>
				<ul>
					<li><a data-href="complains/getAllComplains.action" data-title="举报反馈列表" href="javascript:void(0)">举报反馈信息列表</a></li>
					<li><a data-href="complains/queryComplainsByCond.action" data-title="举报反馈查询" href="javascript:void(0)">举报反馈信息查询</a></li>
				</ul>
			</dd>
		</dl>
