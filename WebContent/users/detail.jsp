				...
				<div class="textInfo">
					<form action="index/addcart.action" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
						...
						<ul class="ul2 clearfix">
							...
							<li class="clearfix">
								<dd>
									<strong>房源类型：</strong><a href="index/cate.action?id=${goods.cateid }">${goods.catename }</a>
								</dd>
							</li>
							<li class="clearfix">
								<dd>
						...
						<c:if test="${sessionScope.role eq '房客'}">
							<c:if test="${goods.storage ne '0'}">
								<ul class="bnt_ul">
									<li class="clearfix">
										<dd>
											<strong>预约次数：</strong> <input name="num" type="text" id="number" value="1" size="4"
									...
									<li class="padd">
<%--										<input type="image" src="themes/ecmoban_benlai/images/goumai2.png" />--%>
<%--										<input type="submit" style="height: 42px;width: 134px;background: #669900;color: white;font-size: 17px;" />--%>
										<button type="submit"  style="height: 42px;width: 134px;background: #669900;color: white;font-size: 17px;">加入预约清单</button>
									</li>
								</ul>
							</c:if>
						</c:if>
