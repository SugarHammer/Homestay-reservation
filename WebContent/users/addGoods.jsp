					...
					<div class="userCenterBox boxCenterList clearfix" style="_height: 1%;">
						...
						<form action="index/addGoods.action" name="myform" method="post">
							<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
								<tr>
									<td width="15%" align="right" bgcolor="#FFFFFF">房源名称：</td>
									<td width="85%" align="left" bgcolor="#FFFFFF"><input name="goodsname" type="text" size="25"
										class="inputBg" id="goodsname" placeholder="请输入房源名称" /></td>
								</tr>
								<tr>
									<td width="15%" align="right" bgcolor="#FFFFFF">房源类型：</td>
