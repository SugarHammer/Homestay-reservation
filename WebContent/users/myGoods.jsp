					...
					<div class="userCenterBox boxCenterList clearfix" style="_height: 1%;">
						...
						<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
							<tr align="center" bgcolor="#ffffff">
								<td align="center" bgcolor="#ffffff">房源名称</td>
								<td align="center" bgcolor="#ffffff">房源类型</td>
								<td align="center" bgcolor="#ffffff">价格</td>
								<td align="center" bgcolor="#ffffff">上架日期</td>
								<td align="center" bgcolor="#ffffff">供租人数</td>
								<td align="center" bgcolor="#ffffff">预约量</td>
